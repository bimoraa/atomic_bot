      ...
      components: [
        component.container({
          components: [
            component.section({
              content: [
                "## <:rbx:1447976733050667061> Helper and Supporter Ticket",
                "",
                "All members, including non-buyers, who need assistance with scripts, features, usage guidance, or general questions about Atomic products.",
                "",
