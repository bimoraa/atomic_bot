...
import { load_commands, register_commands }                              from "@atomic/interfaces/discord/handlers/command.handler"
import { handle_interaction }                                            from "@atomic/interfaces/discord/router"
import { load_sub_commands, sub_commands }                               from "@atomic/interfaces/discord/handlers/sub_command.handler"
...
import { load_close_requests }                                           from "@atomic/modules/staff/routes/close_request"
...
import { handle_afk_return, handle_afk_mentions }                        from "@atomic/modules/utility/controllers/utility.controller"
import { load_afk_from_db, load_afk_ignored_channels_from_db }           from "@atomic/infrastructure/cache/afk"
...
import { start_service_provider_cache, stop_service_provider_cache }     from "@atomic/infrastructure/api/service_provider_cache"
import { db, component }                                                 from "@shared/utils"
import { log_error }                                                     from "@shared/utils/error_logger"
import { check_spam }                                                    from "@atomic/infrastructure/cache/anti_spam"
import { load_reminders_from_db }                                        from "@atomic/modules/reminder/routes/reminder"
...
import { start_webhook_server, set_bot_ready, warm_credits_cache_from_db }           from "@atomic/interfaces/http/server"
import { start_scheduler }                                               from "@atomic/modules/staff/routes/schedule_hwid_less"
import { start_weekly_reset_scheduler }                                  from "@atomic/modules/work/schedulers/weekly_work_reset"
import { start_quarantine_scheduler }                                    from "@atomic/modules/quarantine/schedulers/quarantine_release"
import { start_tag_quarantine_checker }                                  from "@atomic/modules/quarantine/schedulers/tag_quarantine_checker"
import { load_middleman_tickets_on_startup }                             from "@atomic/modules/middleman/schedulers/load_middleman_tickets"
import { start_share_settings_forum_scheduler }                          from "@atomic/modules/share_settings/schedulers/share_settings_forum"
import * as share_settings                                               from "@atomic/modules/share_settings/controllers/share_settings.controller"
import { recover_active_sessions }                                       from "@atomic/modules/staff/controllers/staff_voice.controller"
...
import "@atomic/interfaces/discord/events/guild_member/guild_member_add"
