...
import { load_commands, register_commands }                              from "@discord/handlers/command.handler"
import { handle_interaction }                                            from "@discord/router"
import { load_sub_commands, sub_commands }                               from "@discord/handlers/sub_command.handler"
import { handle_auto_reply }                                             from "@database/settings/auto_reply"
import { start_roblox_update_checker }                                   from "@services/roblox_update"
import { load_close_requests }                                           from "@commands/staff-management/staff/close_request.commands"
import { load_all_tickets, flush_all_tickets }                           from "@database/unified_ticket"
import * as tempvoice                                                    from "@services/tempvoice"
import { register_audit_logs }                                           from "@services/audit_log"
import { handle_afk_return, handle_afk_mentions }                        from "@commands/server-util/afk/controller/afk.controller"
import { load_afk_from_db, load_afk_ignored_channels_from_db }           from "@integrations/cache/afk"
import { check_server_tag_change, scan_banned_tags_on_startup }           from "@database/settings/server_tag"
import { start_free_script_checker }                                     from "@managers/free_script.manager"
import { start_service_provider_cache, stop_service_provider_cache }     from "@integrations/api/service_provider_cache"
import { db, component, api }                                            from "@utils"
import { log_error }                                                     from "@utils/error_logger"
import { check_spam }                                                    from "@integrations/cache/anti_spam"
import { load_reminders_from_db }                                        from "@commands/server-util/reminder/reminder.commands"
import { start_loa_checker }                                             from "@services/loa_checker"
import { start_invite_logger }                                           from "@services/invite_logger"
import { start_webhook_server, set_bot_ready, warm_credits_cache_from_db }           from "@http/server"
import { start_scheduler }                                               from "@commands/staff-management/staff/schedule_hwid_less.commands"
import { start_weekly_reset_scheduler }                                  from "@commands/staff-management/work/jobs/weekly_work_reset.job"
import { start_quarantine_scheduler }                                    from "@commands/moderation/quarantine/jobs/quarantine_release.job"
import { start_tag_quarantine_checker }                                  from "@commands/moderation/quarantine/jobs/tag_quarantine_checker.job"
import { is_quarantined, get_all_quarantines }                          from "@managers/quarantine.manager"
import { start_account_tracker_offline_checker }                         from "@commands/server-util/account-tracker/jobs/account_tracker_offline.job"
import { load_middleman_tickets_on_startup }                             from "@commands/commerce/middleman/jobs/load_middleman_tickets.job"
import { start_share_settings_forum_scheduler }                          from "@commands/commerce/share-settings/jobs/share_settings_forum.job"
import * as share_settings                                               from "@commands/commerce/share-settings/controller/share_settings.controller"
import { recover_active_sessions }                                       from "@commands/staff-management/staff/controller/staff_voice.controller"
import { init_shoukaku }                                                 from "@integrations/lavalink/shoukaku"
import { handle_music_prefix_command }                                   from "@commands/media/music/controller/prefix.controller"
import { handle_security_automod_message }                               from "@commands/moderation/security/controller/security_automod.controller"
...
import "@discord/events/guild_member/guild_member_add"
import "@discord/events/guild_member/guild_member_booster"
import "@discord/events/voice/voice_state_update"
import "@discord/events/message/message_delete"
import "@discord/events/message/executor_update"
import "@discord/events/anti_nuke/channel_delete.event"
import "@discord/events/anti_nuke/channel_create.event"
import "@discord/events/anti_nuke/role_delete.event"
import "@discord/events/anti_nuke/role_create.event"
import "@discord/events/anti_nuke/guild_ban_add.event"
import "@discord/events/anti_nuke/guild_member_remove.event"
import "@discord/events/anti_nuke/webhook_update.event"
